 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vI(r){mn(new rn("platform-logger",e=>new PC(e),"PRIVATE")),mn(new rn("heartbeat",e=>new pI(e),"PRIVATE")),Wt(Qc,$m,r),Wt(Qc,$m,"esm2017"),Wt("fire-js","")}vI("");var yI="firebase",wI="11.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Wt(yI,wI,"app");const U_="@firebase/installations",Pd="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pv(r,e,t=!1){if(Vt(r.app))return Promise.reject(An(r));const s="signIn",o=await xv(r,s,e),l=await Vr._fromIdTokenResponse(r,s,o);return t||await r._updateCurrentUser(l.user),l}async function Lk(r,e){return Pv(Qr(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Av(r){const e=Qr(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Mk(r,e,t){if(Vt(r.app))return Promise.reject(An(r));const s=Qr(r),c=await nd(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Ok).catch(p=>{throw p.code==="auth/password-does-not-meet-requirements"&&Av(r),p}),h=await Vr._fromIdTokenResponse(s,"signIn",c);return await s._updateCurrentUser(h.user),h}function Fk(r,e,t){return Vt(r.app)?Promise.reject(An(r)):Lk(ot(r),Wi.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&Av(r),s})}function jk(r,e,t,s){return ot(r).onIdTokenChanged(e,t,s)}function Uk(r,e,t){return ot(r).beforeAuthStateChanged(e,t)}function Vd(r,e,t,s){return ot(r).onAuthStateChanged(e,t,s)}function zk(r){return ot(r).signOut()}const Ya="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mR{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Vt(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){xt(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,o.additional_types.forEach(Ht=>{Y+=`- ${Ht.label} (${(Ht.score*100).toFixed(2)}%)
`}),Y+=`
`),Y+=`SUMMARY:
${o.narrative}

`,o.main_visual_elements&&o.main_visual_elements.length>0&&(Y+=`VISUAL ELEMENTS:
`,o.main_visual_elements.forEach(Ht=>{Y+=`- ${Ht}
`}),Y+=`
...
`)),ae+=".txt",at="text/plain"):(Q==="docx"||Q==="pdf")&&(Y=`<html>
        ...
        <body>
          ...
          <ul>
            ${o.additional_types.map(Ht=>`<li>${Ht.label} (${(Ht.score*100).toFixed(2)}%)</li>`).join("")}
          </ul>`:""}
